/**
 * ============================================================
 *  TREXANH ENGINE v1.0.0 (Next.js port)
 *  Giữ nguyên toàn bộ logic từ bản gốc v2.4, chỉ bỏ hook Pet Game
 *  (trackStudyXP) vì Pet Game không còn trong bản Next.js này.
 * ============================================================
 */
...
async function init() {
    ...
    filesToLoad.forEach(file => {
        const count = getByCategory(file.name).length;
        const btn   = document.createElement('button');
...
window.filterByFile = function(fileName) {
    ...
    let base = [...getByCategory(fileName)];
